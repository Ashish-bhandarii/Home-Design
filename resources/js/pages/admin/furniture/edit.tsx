...
export default function FurnitureEdit({ furniture, categories, rooms }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        stock: furniture.stock.toString(),
        availability: furniture.availability || 'In Stock',
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(`/admin/furniture/${furniture.id}`, {
            forceFormData: true,
        });
    };
    ...
    return (
        <AdminLayout
            breadcrumbs={[
                ...
                { title: 'Edit Furniture', href: `/admin/furniture/${furniture.id}/edit` },
            ]}
        >
            <Head title="Edit Furniture - Admin" />
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Edit Furniture</h1>
                        <p className="text-slate-600 dark:text-slate-400">Update furniture item details</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        >
                            ...
                            {processing ? 'Saving...' : 'Update Furniture'}
                        </button>
                    </div>
                </form>
            </div>
