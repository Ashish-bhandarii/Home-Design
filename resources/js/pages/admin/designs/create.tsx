...
export default function CreateDesign() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        title: '',
        description: '',
        type: 'floor_plan' as 'floor_plan' | 'home_design' | 'interior_design',
        category: '',
    ...
    return (
        <AdminLayout
            breadcrumbs={[
                ...
                { title: 'Create', href: '/admin/designs/create' },
            ]}
        >
            ...
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Add New Design</h1>
                        <p className="text-slate-600 dark:text-slate-400">Create a new floor plan or home design</p>
                    </div>
                </div>
