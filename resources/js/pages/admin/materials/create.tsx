...
export default function MaterialCreate({ categories, types, units }: Props) {
    const [imagePreview, setImagePreview] = useState<string | null>(null);
    const [availableTypes, setAvailableTypes] = useState<string[]>(types[categories[0]] || []);

    const { data, setData, post, processing, errors } = useForm({
        name: '',
        description: '',
        category: categories[0] || 'Construction',
        type: availableTypes[0] || 'Structural',
        price_per_unit: '',
        unit: units[0] || 'piece',
    ...
    return (
        <AdminLayout
            breadcrumbs={[
                ...
                { title: 'Add Material', href: '/admin/materials/create' },
            ]}
        >
            <Head title="Add Material - Admin" />
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Add New Material</h1>
                        <p className="text-slate-600 dark:text-slate-400">Create a new material for the library</p>
                    </div>
                </div>
